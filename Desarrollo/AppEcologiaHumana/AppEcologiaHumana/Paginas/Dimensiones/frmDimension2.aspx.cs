...
{
    public partial class frmDimension2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable resultadoDT = objBll.ResultadoDimension(ref msgError, 2, ObjLoginDal.IdUsuario);
        ...
        private void CargarPreguntas()
        {
            try
            {
                ...
                DataTable dtPreguntas1 = objBll.ListarPreguntasDimensionTipo(ref msgError, 2, 1);
                if (msgError.Equals(string.Empty) && dtPreguntas1 != null)
                {
                    ...
                    DataTable dtPreguntas2 = objBll.ListarPreguntasDimensionTipo(ref msgError, 2, 2);
        ...
        protected void btnCrear_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Response.Redirect("~/Paginas/Dimensiones/frmDimension2.aspx");
                }
            }
            catch (Exception)
            {
