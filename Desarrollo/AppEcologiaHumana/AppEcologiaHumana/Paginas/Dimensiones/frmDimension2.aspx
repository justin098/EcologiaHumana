<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmDimension2.aspx.cs" Inherits="AppEcologiaHumana.Paginas.Dimensiones.frmDimension2" %>
            ...
            <div class="goals">
                ...
                <div class="item">
                    <div class="in">
                        <div>
                            <h4>Dimensión 2</h4>
                            <p runat="server" id="lblResDim2">000/000</p>
                        </div>
        ...
        <div class="section mt-2 mb-2">
            ...
            <div class="goals">
                ...
                <div class="item">
                    <div class="in">
                        <div>
                            <h4>Respuestas ya han sido enviadas para la dimensión 2, intentelo el día de mañana.</h4>
                        </div>
                    </div>
                </div>
            </div>
