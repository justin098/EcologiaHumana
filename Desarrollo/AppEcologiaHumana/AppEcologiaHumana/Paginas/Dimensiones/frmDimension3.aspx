<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmDimension3.aspx.cs" Inherits="AppEcologiaHumana.Paginas.Dimensiones.frmDimension3" %>
            ...
            <div class="goals">
                ...
                <div class="item">
                    <div class="in">
                        <div>
                            <h4>Dimensión 3</h4>
                            <p runat="server" id="lblResDim3">000/000</p>
                        </div>
        ...
        <div class="section mt-2 mb-2">
            ...
            <div class="goals">
                ...
                <div class="item">
                    <div class="in">
                        <div>
                            <h4>Respuestas ya han sido enviadas para la dimensión 3, intentelo el día de mañana.</h4>
                        </div>
                    </div>
                </div>
            </div>
