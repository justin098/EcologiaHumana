    ...
    public partial class frmReporteUsuarios : System.Web.UI.Page
    {
        ...
        private void ObtenerUsuarios()
        {
            try
            {
                ...
                DataTable dtUsuarios = objBll.ListarUsuariosReporte(ref msgError);
        ...
        protected void gdvPreguntas_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    TableCell estado = e.Row.Cells[2];
                    if (estado.Text == "True")
                    {
                        estado.Text = "Activo";
                    }
        ...
        protected void lnkExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "ReporteUsuarios" + DateTime.Now + ".xls"));
